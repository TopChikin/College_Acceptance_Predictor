...
class data_storage:
    ...
    def get_train_flatten_data(self, float):
        ...
        return (self.flatten_data(self.app_list[:train_index]), self.app_accept[:train_index]), (
        self.flatten_data(self.app_list[train_index:]), self.app_accept[train_index:])
    ...
    def remove_errors(self):
        ...
        self.app_list_flatten = self.flatten_data(self.app_list)
        return num_errors
    ...
    def flatten_data(self, data_list):

        new_app_list_flatten = []

        for app in data_list:
            for i in app:
                new_app_list_flatten.append(i)

        return new_app_list_flatten
